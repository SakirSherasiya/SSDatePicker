...
For show datepicker in your viewController just type below code:
  ...
  ![Alt text]
  (https://github.com/SakirSherasiya/SSDatePicker/blob/master/ScreenShot/Simulator%20Screen%20Shot%2014-Jul-2017,%2010.05.30%20AM.png "screenShot")
...
First set format of datePicker then execute SSDatepicker show method
  ...
  ![Alt text]
  (https://github.com/SakirSherasiya/SSDatePicker/blob/master/ScreenShot/Simulator%20Screen%20Shot%2014-Jul-2017,%2010.10.50%20AM.png "screenShot")
...
Firsr set default date in datePicker then execute SSDatePicker show method
  ...
  ![Alt text]
  (https://github.com/SakirSherasiya/SSDatePicker/blob/master/ScreenShot/Simulator%20Screen%20Shot%2014-Jul-2017,%2010.14.07%20AM.png "screenShot")
